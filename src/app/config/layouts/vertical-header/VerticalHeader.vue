...
import { isTechMode } from "@/utils/constants";
...
const auth = useAuth();
const height = computed(() => (isTechMode ? 125 : "64"));
...
<template>
  <v-app-bar elevation="0" :priority="priority" color="background" id="top" :height="height" class="vertical-header pt-5 pb-2 mb-3">
    <!-- <div class="testInfo" v-if="true">
      <p>imp.ihma.uz Ахборот тизимида техник ишлар амалга оширилмоқда!!!</p>
    </div> -->
    <div class="header">
...
.testInfo {
  ...
  p {
    color: white;
    font-size: 20px;
    animation: textLoop 25s infinite linear;
    width: 100%;
    font-size: 14px;
    line-height: 18px;
    font-weight: 700;
